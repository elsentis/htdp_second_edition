...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname exercise093-chapter005) (read-case-sensitive #t) (teachpacks ((lib "universe.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "universe.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp")) #f)))
; exercise093-chapter005

; Q.:
; Copy your solution to exercise 92 and modify the copy so that the chameleon walks across a tricolor background.
; Observe how the chameleon changes colors to blend in as it crosses the border between two colors.
...
(define CHAM-SCENE-BACKGROUND (beside (empty-scene (round (/ WIDTH 3)) CHAM-SCENE-HEIGHT "green")
                                      (empty-scene (round (/ WIDTH 3)) CHAM-SCENE-HEIGHT "white")
                                      (empty-scene (round (/ WIDTH 3)) CHAM-SCENE-HEIGHT "red")))
...
(define CHAM-COLOR-WHITE-NAME "red")
...
; down array for change hap
; right and left for change path direction
