...
;(check-expect (tl-render "red") (place-image (circle BULB-RADIUS "solid" "red") (/ WIDTH 8) (/ HEIGHT 2)
...
;(check-expect (tl-render "yellow") (place-image (circle BULB-RADIUS "outline" "red") (/ WIDTH 8) (/ HEIGHT 2)
;                                             (place-image (circle BULB-RADIUS "outline" "gold") (* (/ WIDTH 8) 3) (/ HEIGHT 2)
;                                                          (place-image (circle BULB-RADIUS "solid" "yellow") (* (/ WIDTH 8) 5) (/ HEIGHT 2)
;                                                                       (place-image (circle BULB-RADIUS "outline" "green") (* (/ WIDTH 8) 7) (/ HEIGHT 2) BACKGROUND)))))

(define (tl-render current-state)
  (place-image (circle BULB-RADIUS (if (string=? current-state "red") "solid" "outline") "red") (/ WIDTH 8) (/ HEIGHT 2)
               (place-image (circle BULB-RADIUS (if (string=? current-state "gold") "solid" "outline") "gold") (* (/ WIDTH 8) 3) (/ HEIGHT 2)
                            (place-image (circle BULB-RADIUS (if (string=? current-state "yellow") "solid" "outline") "yellow") (* (/ WIDTH 8) 5) (/ HEIGHT 2)
                                         (place-image (circle BULB-RADIUS (if (string=? current-state "green") "solid" "outline") "green") (* (/ WIDTH 8) 7) (/ HEIGHT 2) BACKGROUND)))))