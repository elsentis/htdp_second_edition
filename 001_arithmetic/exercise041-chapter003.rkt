...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname exercise041-chapter003) (read-case-sensitive #t) (teachpacks ((lib "universe.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "universe.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp")) #f)))
...
(define (render cw)
  (place-image CAR (+ (/ CAR-WIDTH 2) cw) Y-CAR BACKGROUND-TREE))
...
(define (end? cw)
  (if (< cw (+ WIDTH CAR-WIDTH)) #false #true))
