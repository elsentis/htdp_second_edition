...
(define (edit ed ke)
  (cond
    ...
    [(aux-edit-right-margin ed WIDTH TYPESIZE) ed]
...
(define (aux-edit-right-margin ed width type)
  (cond [(<= 0 (- width (* (/ type TYPE_WIDTH_INDEX) (+ (string-length (editor-pre ed)) (string-length (editor-post ed))))))
         #false]
        [else #true]))
